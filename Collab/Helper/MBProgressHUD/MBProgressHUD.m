...
+(MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view lineColor:(UIColor*)lineColor progressColor:(UIColor*)progressColor hudMode:(MBProgressHUDMode)mode animated:(BOOL)animated
{
    ...
    if ( hud.mode == MBProgressHUDModeDeterminateHorizontalBar)
    {
        ...
        if ([hud.indicator isKindOfClass:[MBBarProgressView class]])
        {
            MBBarProgressView * indicator  = (MBBarProgressView*)hud.indicator;
            indicator.lineColor = lineColor;
            indicator.progressColor = progressColor;
        }
        
    }
    else if ( hud.mode == MBProgressHUDModeDeterminate || mode == MBProgressHUDModeAnnularDeterminate) {
        if ([hud.indicator isKindOfClass:[MBBarProgressView class]])
        {
            MBBarProgressView * indicator  = (MBBarProgressView*)hud.indicator;
            indicator.lineColor = lineColor;
        ...
        {
            if ([hud.indicator isKindOfClass:[MBRoundProgressView class]])
            {
                MBRoundProgressView * indecator  = (MBRoundProgressView*)hud.indicator;
                [indecator  setProgressTintColor:progressColor];
