...
static NSString * const kMARKRangeSliderThumbImage = @"slider_circle";
static NSString * const kMARKRangeSliderTrackImage = @"rangeSliderTrack";
static NSString * const kMARKRangeSliderTrackRangeImage = @"rangeSliderTrackRange";
...
- (void)setDefaults
{
    ...
    self.minimumValue = 18.0f;
    self.maximumValue = 40.0f;
}
